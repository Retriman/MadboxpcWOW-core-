...
-- horde teleporters
UPDATE `gameobject_template` SET `faction` = 1995 WHERE entry = 195314;
UPDATE `gameobject_template` SET `faction` = 1995 WHERE entry = 195313;
-- alliance teleporters
UPDATE `gameobject_template` SET `faction` = 1997 WHERE entry = 195315;
UPDATE `gameobject_template` SET `faction` = 1997 WHERE entry = 195316;
